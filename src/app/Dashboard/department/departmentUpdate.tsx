...
export default function UpdateDeprt({
  ...
  const { data: dataOfDepartment,error } = useGetDepartmentById(id);
  ...
  const mutation = useMutation({
    ...
    mutationFn: (data: departmentType,) => departmentUpdate(data, id,cookies.authToken), // استخدم الدالة المعدلة
    onError: (err: any) => {
